...
def image_exchange_part():
    ...
    try:
        ...
        return render_template("upload/expart.html", username=username, error_msg=error_msg)
    ...
    idpic = str(fname[11:-4] + f3[11:-4] + partname)
    # session['pic'] = 'app/static/' + idpic + '.jpg'
    ...
    swap.set_error(None)
    return render_template("upload/expart.html", username=username, error_msg=error_msg, urls=get_urls())
